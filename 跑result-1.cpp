...
int main()
{
    ...
    char exist4[40];
    char exist5[40];
    FILE *file,*file1,*file2,*file3,*file4,*Presence1,*Presence2,*Presence3,*Presence4,*Presence5,*run,*Presence;
    int ii,jj,i=0,j=0,a=0,arri=0,arrj=0,checkarr=0,b=0,c,math1=0,math2=0,math3=0,math4=0,pree=0,Interval=0,Dwell_time=0,Latency=0,Flight_time=0,Up_to_up=0,num_std=0,Punctuation=0,word=0,r=-2,preInterval=0,totalword1=0,totalword2=0,wordi=0,wordj=0;
    int round,trainer;
